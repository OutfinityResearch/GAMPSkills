...
3. Call quality expert for the generated DS content, with profile DS, provide as instructions the changes that you expect have been made and to verify if they have been made.
4. Write the result from step 3 to the same file path using file-system writeFile.

- Do not modify files that are not affected by the user prompt.
