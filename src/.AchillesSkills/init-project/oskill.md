...
- Generate content for `./specs_backlog.md` with project-specific questions and proposals based on the user prompt, regarding the initial DS files and whether to add more DS files. You must also provide a list of affected files (relative paths) for the task.
