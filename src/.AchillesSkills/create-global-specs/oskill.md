...
## Description
The create-global-specs skill generates high-level Global Design Specifications (DS) that capture the project's vision, scope, audience, components, and workflow. It synthesizes user input with approved backlog items to produce files like vision and workflow documents under the project's specs directory, while updating backlog statuses to reflect progress.
