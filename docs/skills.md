...
Metadata-only reference skills. They provide a title, summary, and body content and are used as documentation or lightweight capability descriptions. They do not call the LLM at runtime and do not execute any code.
